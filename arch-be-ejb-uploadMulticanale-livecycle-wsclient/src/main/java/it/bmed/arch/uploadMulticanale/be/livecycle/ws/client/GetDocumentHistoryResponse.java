 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://dispatcher.cedacrinternational.md/}uimHistory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetDocumentHistoryResponse {
    ...
    protected List<UimHistory> _return;
     ...
     * 
     */
    public List<UimHistory> getReturn() {
        if (_return == null) {
            _return = new ArrayList<UimHistory>();
        }
        return this._return;
    }
